...
class WebsiteSettingRequest extends FormRequest
{
    ...
    protected function prepareForValidation(): void
    {
        $this->merge([
            ...
            'pad_realisasi_value' => $this->filled('pad_realisasi_value') ? (float) str_replace(['.', ','], '', (string) $this->input('pad_realisasi_value')) : null,
            'pad_target_text' => $this->filled('pad_target_text') ? (float) str_replace(['.', ','], '', (string) $this->input('pad_target_text')) : null,
            'pad_percentage' => $this->filled('pad_percentage') ? (float) str_replace(',', '.', (string) $this->input('pad_percentage')) : null,
            'pad_updated_at' => $this->filled('pad_updated_at') ? trim((string) $this->input('pad_updated_at')) : null,
            'pad_status' => $this->filled('pad_status') ? trim((string) $this->input('pad_status')) : null,
    ...
    public function rules(): array
    {
        return [
            ...
            'pad_realisasi_value' => ['nullable', 'numeric'],
            'pad_target_text' => ['nullable', 'numeric'],
            'pad_percentage' => ['nullable', 'numeric', 'min:0', 'max:100'],
            'pad_updated_at' => ['nullable', 'string', 'max:255'],
            'pad_status' => ['nullable', 'string', 'max:255'],
