...
class WebsiteSettingRequest extends FormRequest
{
    ...
    protected function prepareForValidation(): void
    {
        $this->merge([
            ...
            'hero_slide_1' => $this->filled('hero_slide_1') ? trim((string) $this->input('hero_slide_1')) : null,
            'hero_slide_2' => $this->filled('hero_slide_2') ? trim((string) $this->input('hero_slide_2')) : null,
            'hero_slide_3' => $this->filled('hero_slide_3') ? trim((string) $this->input('hero_slide_3')) : null,
    ...
    public function rules(): array
    {
        return [
            ...
            'hero_slide_1' => ['nullable', 'string', 'max:255'],
            'hero_slide_2' => ['nullable', 'string', 'max:255'],
            'hero_slide_3' => ['nullable', 'string', 'max:255'],
