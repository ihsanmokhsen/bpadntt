...
class WebsiteSettingRequest extends FormRequest
{
    ...
    protected function prepareForValidation(): void
    {
        $this->merge([
            ...
            'pad_realisasi_value' => $this->filled('pad_realisasi_value') ? trim((string) $this->input('pad_realisasi_value')) : null,
            'pad_target_text' => $this->filled('pad_target_text') ? trim((string) $this->input('pad_target_text')) : null,
            'pad_percentage' => $this->filled('pad_percentage') ? trim((string) $this->input('pad_percentage')) : null,
    ...
    public function rules(): array
    {
        return [
            ...
            'pad_realisasi_value' => ['nullable', 'string', 'max:255'],
            'pad_target_text' => ['nullable', 'string', 'max:255'],
            'pad_percentage' => ['nullable', 'string', 'max:50'],
